...
public class FileListAdapter extends ArrayAdapter<DCFileList> {
	...
	public static class FileType {
		...
		public static String[] VideoExtensions = { "mkv", "mp4", "rmvb", "avi",
				"mpeg", "flv", "mpg", "wmv", "divx" };
		public static String[] MusicExtensions = { "mp3", "wav", "aac", "ogg" };
		public static String[] ImageExtensions = { "bmp", "jpg", "jpeg", "png",
				"gif", "ico", "jpe" };
		public static String[] DocExtensions = { "xls", "doc", "ppt", "xlsx",
				"pptx", "docx", "odt", "odp" };
		...
		public static String[] internetExtensions = { "htm", "html", "js",
				"css" };
		public static String[] textExtensions = { "txt", "dat", "xml", "rtf",
				"srt", "chm" };
		public static String[] compressedExtensions = { "zip", "7z", "tar",
				"gz", "rar", "jar" };
